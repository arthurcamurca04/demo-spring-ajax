package com.mballen.demoajax.web.model;
...
public class Promocao implements Serializable{
	...
	@NotBlank(message = "Um link da promoção é requirido")
	...
	public String toString() {
		return "Promocao [id=" + id + ", titulo=" + titulo + ", link=" + link + ", site=" + site + ", descricao="
