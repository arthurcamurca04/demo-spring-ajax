$(document).ready(function(){
	...
	//ação de marcar e desmarcar botões ao clicar na ordenação
	$("#table-server thead").on("click", "tr", function(){		
		table.buttons().disable();		
	});
	
	//ação de marcar e desmarcar linhas clicadas
		 ...
		 if(isSelectedRow()){
			 ...
			 $.ajax({
				...
				url: "/promocao/edit/" + id,
			 	...
			 	error: function(){
			 		alert("Opa, algum erro ocorreu. Tente novamente...");
			 	}
	...
	//alterar a imagem do componente <img>
	...
	$("#btn-del-modal").on("click", function(){
		...
		$.ajax({
			...
			error: function(){
				alert("Opa, ocorreu um erro! Tente mais tarde...")
			}
		});
	});
