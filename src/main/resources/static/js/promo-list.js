...
function loadByScrollBar(pageNumber){
	...
	$.ajax({
		...
		error: function(xhr){
			alert("Opa, ocorreu um erro inesperado: " + xhr.status + " - " + xhr.statusText);
		},
		complete: function(){
			$("#loader-img").hide();
		}
...
//botão confirmar do autocomplete
...
$("#autocomplete-submit").on("click", function(){
	...
	$.ajax({
		...
		error: function(xhr){
			alert("Opa, algo deu errado: " + xhr.status + ", " + xhr.statusText);
		}
	});
});
...
function showButton(count){
	...
	$("#btn-alert").show(function(){
		$(this).attr("style", "display: block;").text("Veja " + totalOfertas + " nova(s) ofesta(s)!");
	})
}
